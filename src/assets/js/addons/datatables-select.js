 ...
 * @description A category of API methods, events and buttons for DataTables
...
Select is a category of API methods, event handlers, event emitters and
...
extent, these of API methods *is* Select. It is basically a category of helper
